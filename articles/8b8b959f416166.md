...
<details>
<summary>Lazy Hydration の詳細な説明と使用例</summary>

TODO: ここに Lazy Hydration の詳細な説明と使用例を記載する
...
`Teleport`は、コンポーネントのテンプレート内の一部のコンテンツを DOM の別の場所にレンダリングすることができる Vue の組み込み機能です。Teleportの基本的な使い方については、[Vue.js 公式ドキュメントのTeleportセクション](https://v3.vuejs.org/guide/teleport.html)を参照してください。

<details>
<summary>Deferred Teleport の詳細な説明と使用例</summary>
